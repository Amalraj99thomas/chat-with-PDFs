...
#returns string of all text in all pdfs
...
#returns dictionary of divided text chunks
...
#get embeddings from Huggingface API of our text chunks
...
def main():
    load_dotenv()  # To access the API keys
    ...
    with st.sidebar:
        ...
        if st.button("Process"):  #when process is  clicked
